...
static void inc_regptr(DS1338State *s)
{
     ...
     * DS1338, 0x10 on the DS1339); wraparound causes the current time/date to
     * be retransferred into the secondary registers.
     */
...
static void ds1338_class_init(ObjectClass *klass, const void *data)
{
    ...
    dsc->ctrl_reset = 0;
    dsc->status_reset = 0;
    dsc->eosc_mask = 0;                 /* control bit 7 is OUT, not EOSC */
    dsc->osf_bit = 0;
    dsc->century_mask = 0;              /* no century bit on the DS1338 */
}
