...
#define DS1338_CTRL_OSF  0x20  /* OSF is bit 5 of the control register */

/* The time registers (0x00..0x06) hold the clock and calendar. */
...
/* The register pointer should wrap at 0x40. */
